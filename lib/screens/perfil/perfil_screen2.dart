...
class _PerfilScreenState extends State<PerfilScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _uid == null || _driverDocRef == null
          ...
          Row(
            ...
            children: [
              Container(
                ...
                clipBehavior: Clip.antiAlias,
                child: (carroUrl.isNotEmpty)
                    ? Image.network(
                        carroUrl,
                        fit: BoxFit.cover,
                        errorBuilder: (_, __, ___) => const Icon(Icons.directions_car, color: velloOrange, size: 32),
                      )
                    : const Icon(Icons.directions_car, color: velloOrange, size: 32),
              ),
              const SizedBox(width: 16),
              Expanded(
                child: Column(
