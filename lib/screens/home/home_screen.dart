...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void _centerMap() async {
    ...
    if (_onlineService.currentPosition != null) {
      ...
      // Senão, centralizar em São Paulo
          ...
          return Scaffold(
            ...
            body: Stack(
              children: [
                Column(
                  children: [
                    // Banner "Olá, Motorista!" com status em tempo real
                    Container(
                              ...
                              children: [
                                ...
                                if (onlineService.currentPosition != null)
                                  Padding(
                                    ...
                                    child: Text(
                                      'Localização: ${onlineService.currentPosition!.latitude.toStringAsFixed(4)}, ${onlineService.currentPosition!.longitude.toStringAsFixed(4)}',
                                      style: const TextStyle(
                                        fontSize: 10,
  ...
  Widget _buildEarningsCard(String period, String amount, IconData icon, VoidCallback onTap) {
